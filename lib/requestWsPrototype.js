...
Object.assign(prototype, {
  ...
  _pushOpenRequest: function _pushOpenRequest () {
    if (api.session.isClientWindow) {
      ...
      .catch(function (e) {
        if (e && e.errorId && parseInt(e.errorId || 0) === 403) {
          var o = {
            req: null,
            res: null,
            baseUrl: api.baseUrl,
          ...
          o.port = url('port', o.baseUrl)
          o.protocol = url('protocol', o.baseUrl)
          return api.session.init(o)
          .then(function () {
            return this._pushOpenRequest()
          }.bind(this))
        } else {
